import type { IAstPartialMapper, IAstMapper } from './ast-mapper';
import { AstDefaultMapper, astMapper } from './ast-mapper';
import * as a from './syntax/ast';
import type { ReplaceReturnType } from './utils';


export type IAstPartialVisitor = { [key in keyof IAstPartialMapper]: ReplaceReturnType<IAstPartialMapper[key], unknown> };
