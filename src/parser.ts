...
let sqlCompiled: Grammar | undefined;
let arrayCompiled: Grammar | undefined;
let geometricCompiled: Grammar | undefined;
let intervalTextCompiled: Grammar | undefined;
let intervalIsoCompiled: Grammar | undefined;
...
export function parseGeometricLiteral(
    sql: string,
    type: 'point' | 'line' | 'lseg' | 'box' | 'path' | 'polygon' | 'circle',
): GeometricLiteral {
